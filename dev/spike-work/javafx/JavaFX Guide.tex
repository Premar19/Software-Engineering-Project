...
\title{Beginner's Guide To JavaFX - Spike Work}
\author{Group 6}
...
\begin{document}
	...
	\chapter{Image Manipulation}\label{chap:image manipulation}
		...
		\section{Displaying Images}\label{sec:displaying images}
	...
	\chapterauthor{Natalia Spence}
		...
		This chapter is going to serve as one large example that will be built on in each subsection in order to create a whole system. For lack of better idea, I'm going to walk through the creation of a JavaFX version of draughts. This is going to follow my thought process as I create this from scratch, and should help show how to put the elements in the chapters above together into one complex system.
